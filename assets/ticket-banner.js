...
// full card). Depends on UPCOMING_EVENTS being loaded first
// (assets/events-data.js) and on the banner markup existing in the page:
// #ticketBanner / #ticketBannerTrack (see index.html for the reference
// markup, right after <body>).
(function(){
  const active = UPCOMING_EVENTS
